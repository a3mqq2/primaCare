...
<head>
    <meta charset="utf-8" />
    <title>{{ __('cities.print_title') }} - PrimaCare</title>
...
<body onload="window.print()">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $city->name_ar }}</td>
                <td>{{ $city->name_en }}</td>
                <td style="text-align:center">{{ $city->centers_count }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="4" style="text-align:center; padding:20px;">{{ __('cities.no_results') }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="total-count">
        {{ __('cities.total_cities') }}: {{ $cities->count() }}
    </div>
