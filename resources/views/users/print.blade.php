...
<head>
    <meta charset="utf-8" />
    <title>{{ __('users.print_title') }} - PrimaCare</title>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="date-col">{{ $user->created_at->format('Y-m-d') }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="6" style="text-align:center; padding:20px;">{{ __('users.no_results') }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
